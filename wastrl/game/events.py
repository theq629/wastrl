...
send_damage = data.Event(name='send_damage')
take_damage = data.Event(name='take_damage')
handle_damage = data.Event(True, lambda a, b: a and b, name='handle_damage')
...
terrain_change = data.Event(name='terrain_change')
bad_action = data.Event(name='bad_action')
